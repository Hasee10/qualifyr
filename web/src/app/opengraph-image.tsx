    ...
    (
      <div
        style={{
          ...
          padding: "80px",
          background: "linear-gradient(135deg, #0a0a0a 0%, #111 60%, #0f1a16 100%)",
          color: "white",
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          <div
            style={{
              ...
              height: 56,
              borderRadius: 14,
              // Satori (the renderer behind next/og) only understands hex/rgb/hsl, not
              // oklch - this is the sRGB hex equivalent of the --brand token.
              background: "#1e9b74",
            }}
          />
        ...
        <div style={{ display: "flex", marginTop: 48, fontSize: 60, fontWeight: 600, lineHeight: 1.15, maxWidth: 900 }}>
          See who actually{" "}
          <span style={{ color: "#3ecb9a", marginLeft: 16 }}>buys</span>
        </div>
